...
//    @ExceptionHandler(value = com.cpplab.global.common.exception.GeneralException.class)
//    public ResponseEntity onThrowException(com.cpplab.global.common.exception.GeneralException generalException, HttpServletRequest request) {
...
//    }
    ...
    public ResponseEntity<Object> onThrowException(GeneralException generalException, HttpServletRequest request) {
        // GeneralException에서 ErrorReasonDTO를 가져와 응답에 사용
        ErrorReasonDTO errorReasonHttpStatus = generalException.getErrorReasonHttpStatus();
        return handleExceptionInternal(generalException, errorReasonHttpStatus, null, request);
    }
